...
<%
    ...
    try{
		...
		if(command.equals("jdbc") )
		{
		    ...
		    // SQL Server 2005
		    //Driver eduDriver = Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");  
            //con = DriverManager.getConnection(jdbc:sqlserver://"+ip+":"+port+";databaseName="+sid+";user="+username+";password="+password+";");
